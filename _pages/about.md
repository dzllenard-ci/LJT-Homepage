...
2. **On the Perception Bottleneck of VLMs for Chart Understanding**  
   **Junteng Liu\***, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. *arXiv*, 2025. (Code repository: Vision4Chart on GitHub)

**2024**

3. **On the Universal Truthfulness Hyperplane Inside LLMs**  
   **Junteng Liu\***, Shiqi Chen, Yu Cheng, Junxian He. *EMNLP 2024*. (Code repository: Universal_Truthfulness_Hyperplane on GitHub)
